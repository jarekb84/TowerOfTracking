...
// Note: Pure formatting function tests (formatDurationHoursMinutes, formatWaveNumber,
// formatTierWaveHeader, formatTimestampDisplay) are in:
// src/shared/formatting/run-display-formatters.test.ts
