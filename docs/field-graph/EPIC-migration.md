...
_(use this section to capture cross-commit learnings, scope adjustments, or deferred work. Each entry: date + commit number + note.)_
...
3. List anything for "Notes & Findings."
4. If you had to deviate from the spec, say where and why.
```
